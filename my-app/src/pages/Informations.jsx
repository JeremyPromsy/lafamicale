    ...
    return (
            <div className="info">
                ...
                <div className="contentDescription">
                    <Description className="desc desc1" title = {"Intérieur"} content ={"Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées par nos équipes."} />
